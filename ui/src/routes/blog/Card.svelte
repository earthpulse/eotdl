...
<a
    href="/blog/{post.slug}"
    class="w-full bg-white border-2 rounded-xl p-6 flex flex-col h-full text-left min-h-[210px] gap-3"
>
    <div>
        <span>
        ...
        <span
            class="flex flex-row w-full justify-between text-gray-400 text-xs mt-2"
        >
            <p>
