...
def get(
    ...
    \n\n
    If using --path, it will download the model to the specified path. If no path is provided, it will download to the current directory.\n
    ...
    If using --assets, it will download the assets of the model.\n
