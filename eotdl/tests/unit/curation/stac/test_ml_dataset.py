...
def test_add_ml_extension_export(tmp_stac_catalog):
    add_ml_extension(tmp_stac_catalog,
                     destination='tmp/exported_catalog')
...
def test_add_ml_extension_parameters(tmp_stac_catalog):
    ...
    assert tmp_stac_catalog.extra_fields['ml-dataset:inputs-type'] == ['satellite imagery']
...
def test_add_ml_extension_splits(tmp_stac_catalog_labels):
    ...
    assert tmp_stac_catalog_labels.extra_fields['ml-dataset:splits'] == ('Training', 'Validation', 'Test')
