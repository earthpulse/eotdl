<div
  class="border-t grid grid-rows-2 md:grid-rows-1 md:grid-cols-[300px,auto] max-w-6xl px-5 py-10 w-full"
>
  <div>
  ...
  <div>
    ...
    <div class="flex flex-wrap gap-5 items-center">
      <a href="https://earthpulse.ai/" target="_blank">
        <img src="/logos/EP_logo.png" alt="earthpulse logo" class="h-[60px]" />
      </a>
      <a href="https://eox.at/" target="_blank">EOX</a>
      ...
      <a href="https://www.sinergise.com/" target="_blank">
        ...
        /></a
      >
      <a href="https://www.spacetec.partners/" target="_blank">
        <img
