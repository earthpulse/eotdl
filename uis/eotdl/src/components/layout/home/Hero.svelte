<div
	class="py-[66px] w-full md:py-[100px] min-h-[400px] bg-base-200 flex flex-col items-center"
>
	<div
		class="gap-3 max-w-[450px] text-center flex flex-col items-center px-4"
	>
		<h1 class="text-5xl font-bold">Earth Observation Training Data Lab</h1>
		<p class="py-6">
			Create, share and use training data for Earth Observation Machine
		...
		<span>
			...
			<a
				href="/brochure.pdf"
				target="_blank"
				class="btn btn-sm bg-primary text-white border-base-300 capitalize"
			>
				Read the brochure</a
			></span
		>
