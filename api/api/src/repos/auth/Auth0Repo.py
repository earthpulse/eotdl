...
class Auth0Repo:
    ...
    def generate_login_url(self):
        ...
        device_code_response = requests.post(
            "https://{}/oauth/device/code".format(self.domain), data=device_code_payload
        )
    ...
    def generate_id_token(self, code):
        ...
        token_response = requests.post(
            "https://{}/oauth/token".format(self.domain), data=token_payload
        )
    ...
    def validate_token(self, id_token):
        ...
        tv = TokenVerifier(
            signature_verifier=sv, issuer=issuer, audience=self.client_id
        )
        tv.verify(id_token)
